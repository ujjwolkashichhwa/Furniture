                ...
                <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="row">
                            <?php if(count($furniture)>0 ): ?>
                                <?php $__currentLoopData = $furniture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($row['category']=="living-room") : ?>
                    ...
                    <div class="tab-pane fade" id="v-pills-dr" role="tabpanel" aria-labelledby="v-pills-dr-tab">
                        <div class="row">
                            <?php if(count($furniture)>0 ): ?>
                                <?php $__currentLoopData = $furniture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($row['category']=="dining-room") : ?>
                                        <div class="col-sm-4 col-lg-3 col-md-6">
                                            <div class="thumbnail">
                                                <a href="product/<?php echo e($row->id); ?>">
                                                    <img src="public/image/<?php echo e($row->image); ?>" class="img-fluid" alt="Responsive image"   />
                    ...
                    <div class="tab-pane fade" id="v-pills-kr" role="tabpanel" aria-labelledby="v-pills-kr-tab">
                        <div class="row">
                            <?php if(count($furniture)>0 ): ?>
                                <?php $__currentLoopData = $furniture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($row['category']=="kitchen-room") : ?>
                                        <div class="col-sm-4 col-lg-3 col-md-6">
                                            <div class="thumbnail">
                                                <a href="product/<?php echo e($row->id); ?>">
                                                    <img src="public/image/<?php echo e($row->image); ?>" class="img-fluid" alt="Responsive image"   />
                    ...
                    <div class="row">
                            <?php if(count($furniture)>0 ): ?>
                                <?php $__currentLoopData = $furniture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($row['category']=="children-room") : ?>
                                        <div class="col-sm-4 col-lg-3 col-md-6">
                                            <div class="thumbnail">
                                                <a href="product/<?php echo e($row->id); ?>">
                                                    <img src="public/image/<?php echo e($row->image); ?>" class="img-fluid" alt="Responsive image"   />
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OurFurniture\resources\views/guest/product.blade.php ENDPATH**/ ?>