                ...
                <div class="overlay">
                    <div class="carousel-caption d-md-block">
                        ...
                        <button type="button" class="btn btn-outline-success">
                            <a class="link" href="<?php echo e(url('/product')); ?>">Get Started</a>
                        </button>
                        <button type="button" class="btn btn-outline-success">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OurFurniture\resources\views/guest/welcome.blade.php ENDPATH**/ ?>